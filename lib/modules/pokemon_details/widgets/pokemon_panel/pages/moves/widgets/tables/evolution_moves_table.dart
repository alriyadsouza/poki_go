...
import 'package:period_cycle/modules/pokemon_details/widgets/pokemon_panel/pages/moves/widgets/table_moves.dart';
import 'package:period_cycle/shared/stores/pokemon_store/pokemon_store.dart';
import 'package:period_cycle/shared/ui/widgets/pokemon_type_badge.dart';
    ...
    return Observer(builder: (_) {
      if (movesStore.panels[index]) {
        return TableMovesWidget(
          ...
          rows: _pokemonStore.pokemon!.moves.evolution
              .map((move) => [
